...
export class OutputComponent implements OnInit {
  ...
  colors: string[] = [];
  flapc: { value: number; index: number }[] = this.generatorsService.get_flapc();
 LegendText: string[] = [];
  ...
  power_list: number[] = [];
  Output_list:{generators:string; Total_Pmax:number; Total_Pmin:number}[] = [];
